      ...
      sections: [
        {
          ...
          activities: [
            ...
            },
            {
              ...
              summary: 'The final challenge: put five steps in the right order, then drive SwayForm live from your keyboard to grab an object and lift it.',
              workspaceFile: 'swayform_ws/src/swayform_robot/swayform_robot/behaviors/target_lock.py',
              relatedConcepts: ['Sequencing', 'Live control'],
              steps: [
                {
                ...
                },
                {
                  ...
                  blocks: [
                    { type: 'p', text: 'Here they are in alphabetical order — which is not the order they run in. Each one needs something to have happened already. That is the whole puzzle.' },
                    { type: 'table', headers: ['Function', 'What it does', 'What it needs first'], rows: [
                      ['activate_crosshair', 'Turns on the camera overlay.', 'Nothing.'],
                      ['load_controls', 'Loads the keyboard controls.', 'The overlay.'],
                      ['run_system_check', 'Checks the camera, the robot, the motion system, and targeting.', 'The overlay and the controls.'],
                      ['unlock_arm', 'Unlocks the arm and the hand.', 'Movement unlocked.'],
                      ['unlock_movement', 'Unlocks the head and the torso.', 'A passed system check.'],
                    ] },
                  ],
                },
                {
                  id: 'look-at-this-part', title: 'Fill In the Steps',
                  blocks: [
                    ...
                    { type: 'steps', items: [
                      '**Write one function name in each step.** Only the name — no quotes, no extra parentheses. A filled-in step looks like `STEP_1 = (some_function)`.',
                      '**Use each function exactly once,** and change nothing else in the file.',
                      '**Click Run.** If the order is not right yet, Run tells you how many steps are in the right place — not which ones.',
                      '**When Run says you are done, click Queue on Robot.** Once an admin approves it and it starts, the live view opens on this page by itself.',
                    ] },
                  ],
                },
                {
                  id: 'the-controls', title: 'The Controls',
                  blocks: [
                    { type: 'p', text: 'The live view shows the robot\'s camera with the keys listed beside it. A key lights up while you hold it.' },
                    { type: 'table', headers: ['Keys', 'What they move'], rows: [
                      ['Arrow keys', 'The head — look left, right, up, down'],
                      ['R / F', 'Shoulder up / down'],
                      ['W / S', 'Elbow bend / straighten'],
                      ['A / D', 'Shoulder out / in'],
                      ['Q / E', 'Torso turn right / left'],
                      ['Space (hold)', 'Close the hand, slowly'],
                      ['Enter (tap)', 'Open the hand'],
                    ] },
                    { type: 'callout', tone: 'tip', label: 'Hold to move', text: 'Every movement key works only while you hold it. Let go and that part of the robot stops right away. You can hold more than one key at a time — **W** and **A** together bend the elbow while the shoulder swings out.' },
                    { type: 'callout', tone: 'note', label: 'The grip', text: 'Hold **Space** and the hand closes slowly. Let go and it keeps the grip right where it is — it does not spring open. Hold **Space** again to squeeze tighter. **Enter** opens the hand all the way. The grip bar in the live view shows how closed the hand is.' },
                  ],
                },
                {
                  id: 'try-it', title: 'Grab It and Lift It',
                  blocks: [
                    { type: 'p', text: 'When the arm unlocks, it moves by itself to a ready position with the hand in a fist. That takes about two and a half seconds — the arm keys do nothing until it arrives, but the head already works. Then:' },
                    { type: 'steps', items: [
                      '**Look at the object** with the arrow keys.',
                      '**Turn the torso** with **Q** or **E** if the object is off to one side.',
                      '**Raise the shoulder and bend the elbow** until the closed fist is right beside the object.',
                ...
                },
                {
                  ...
                  blocks: [
                    ...
                    { type: 'table', headers: ['What you see', 'What it means'], rows: [
                      ...
                      ['"Releasing in 2 s - hold the bottle."', 'The session is ending and the hand is about to open. Someone should take the object.'],
                      ['"Torso: turning back …"', 'The robot is returning to where it started.'],
                    ] },
                    { type: 'heading', level: 3, text: 'What ends the session' },
                    { type: 'list', items: [
              ...
              completionSummary: { text: 'You assembled a robot\'s plan in the right order, then drove a humanoid live through its own camera — head, torso, arm, and hand — to pick up a real object. You just programmed a humanoid robot.', conceptsUsed: ['Sequencing', 'Dependencies', 'Live control'] },
            },
          ],
        },
      ],
