      ...
      blocks: [
        { type: "lead", text: "Quick definitions for terms used throughout the Learning Portal." },
        {
          ...
          items: [
            ...
            { term: "SSH", def: "A way to remotely connect to the robot's computer from a laptop." },
            ...
            { term: "Validation queue", def: "The system that checks a student submission and holds it for instructor review before it can move the robot." },
            { term: "Student project", def: "A named ROS 2 package generated by the SwayForm project-creation tool for one student or team." },
          ],
        },
      ],
    },
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              symptom: "Cannot SSH into the robot",
              cause: "The laptop is not on the correct network, the robot is not fully powered on, or the hostname is different.",
              fix: "Check power, network connection, and the correct SSH command. Try using the robot's IP address if the hostname does not resolve.",
            },
            {
              symptom: "VS Code cannot connect",
              cause: "The SSH extension is not configured correctly or the robot is unreachable.",
              fix: "Test SSH in a normal terminal first. If terminal SSH works, reopen VS Code and reconnect through the remote SSH menu.",
            },
            {
            ...
            },
            {
              ...
              cause: "The motion node is not running, power is not enabled, or the behavior is blocked by a safety condition or pending queue approval.",
              fix: "Check terminal output, confirm the robot is powered, verify the motion system is active, and confirm your submission was actually approved — see [Validation & Queue](https://learning.swayform.net/queue).",
            },
            {
            ...
            {
              symptom: "Submission stuck in the queue",
              cause: "Automated validation failed, or the instructor has not yet reviewed the submission.",
              fix: "Check the validation status and error messages in the queue interface, fix any reported issue, and ask the instructor to review if it has been waiting a while — see [Validation & Queue](https://learning.swayform.net/queue).",
            },
          ],
        },
      ],
