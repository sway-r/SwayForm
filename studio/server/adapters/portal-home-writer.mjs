...
const APP_IDENT = {
  ...
  // robot/admin/workspace are role-gated at runtime (visibleApps() in
  ...
  // visibility.
  robot: 'RobotApp', admin: 'AdminApp', workspace: 'WorkspaceApp',
};
...
export const APP_FILES = {
  ...
  workspace: 'portal/apps/workspace/workspace.js',
};
